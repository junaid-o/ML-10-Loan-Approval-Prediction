from LoanApproval.entity.config_entity import BaseDataTransformationConfig, DataIngestionConfig,BaseDataIngestionConfig, DataValidationConfig, DataTransformationConfig, ModelTrainerConfig, ModelEvaluationConfig, ModelPusherConfig, TrainingPipelineConfig
from LoanApproval.util.util import read_yaml_file
...
class Configuration:
    ...
    def get_base_data_ingestion_config(self) -> BaseDataIngestionConfig:
        try:
            ...
            #raw_data_dir = os.path.join("LoanAproval//dataset_base",
